...
public class Visita_Docente extends javax.swing.JPanel {

    public Visita_Docente() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel2.setText("<html><center>Estimado Docente/Personal Administrativo, para llevar un control de las vistas<p>de la Biblioteca solo debes teclar tu Numero de Control<html>");
        ...
        matricula_text.setHorizontalAlignment(javax.swing.SwingConstants.RIGHT);
        matricula_text.setText("NUMERO DE CONTROL");
        jPanel1.add(matricula_text, new org.netbeans.lib.awtextra.AbsoluteConstraints(65, 220, -1, 40));

        NUMERODOCENTE.setFont(new java.awt.Font("Gotham", 0, 24)); // NOI18N
        NUMERODOCENTE.setHorizontalAlignment(javax.swing.JTextField.CENTER);
        jPanel1.add(NUMERODOCENTE, new org.netbeans.lib.awtextra.AbsoluteConstraints(380, 220, 360, 40));
    ...
    private void RegistrarVisitaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_RegistrarVisitaActionPerformed
        ...
        //INSERT INTO visita (IDalumno,FechaVisita) values ((select IDalumno from alumno where Matricula = 240), now());
