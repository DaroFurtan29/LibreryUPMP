...
public class Home extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        add(Direccion, new org.netbeans.lib.awtextra.AbsoluteConstraints(70, 230, 126, 20));
        ...
        add(Calle, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 260, -1, -1));
        ...
        add(Colonia, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 280, 240, 10));

        Telefono.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Images/Telefono2.png"))); // NOI18N
        add(Telefono, new org.netbeans.lib.awtextra.AbsoluteConstraints(290, 230, 120, -1));
        ...
        add(Numero, new org.netbeans.lib.awtextra.AbsoluteConstraints(310, 260, 90, 20));

        ext.setFont(new java.awt.Font("Gotham", 0, 12)); // NOI18N
        ext.setForeground(new java.awt.Color(0, 0, 0));
        ext.setText("Ext: 123");
        add(ext, new org.netbeans.lib.awtextra.AbsoluteConstraints(320, 280, 60, 10));

        IMG.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Images/Ilustracion1.png"))); // NOI18N
        add(IMG, new org.netbeans.lib.awtextra.AbsoluteConstraints(436, 0, 651, 458));
